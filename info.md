...
- different types are supported, "Air to Water", "Water to Water" and "Ground to Water"
- animated ventilator, compressor and pumps show activity
- up to three heating circuits can be configured, using radiator or underfloor heating
